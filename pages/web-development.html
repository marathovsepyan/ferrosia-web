        ...
        <div class="container">
          <div class="flex-row">
            <div class="col-4 web-title">
                <h2 class="text-center title-color" >Web Development Solutions for a Modern Business Landscape</h2>
                <p class="text-center">Whether your company needs a new website to engage with customers, an enterprise-class web app to automate processes, or a web portal to help align your employees' workflows, Ferrosia’s custom web developers have the programming expertise and  the industry-specific experience to build it quickly, efficiently and in perfect alignment  with your vision.</p>
                <div class="btn-wrap">
            ...
            <div class="col-6">
              <img class="w-max" src="../img/asset-13-100.jpg" alt="">
            </div>
          </div>
        </div>
      </section>
            ...
            <!-- <section class="section-sm">
                <div class="container">
                    <div class=" s-title-shadow ">

                    </div>
                    <div class="s-title  text-center">
                        <h2>Web Development Solutions for a Modern Business Landscape</h2>
                        <p class="center">Whether your company needs a new website to engage with customers, an enter- <br> prise-class web app to automate processes, or a web portal to help align your employ- <br> ees' workflows, Ferrosia’s custom web developers have the programming expertise and <br> the industry-specific experience to build it quickly, efficiently and in perfect alignment <br> with your vision.</p>
                        <div class=" s-title-shadow "></div>
                    </div> 
                </div> 
            </section> -->
         ...
         <section class="section dev">
            <div class=" s-title-shadow text-center">
                <h1> Hire Web Developers With Experience </h1>
              </div>
                            ...
                            <div class="container">
                              <div class="col-sm-10 col-sm-offset-1">
                                <div class="w-section">
                                  ...
                                  <p>Proficient team, number of efficient mobile apps, numerous success stories and <br> surprising results. You name it, and we have it covered.</p>
