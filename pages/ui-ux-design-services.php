...
<main>
    ...
    <header class="header">
        ...
        <div class="container">
          <div class="flex-row">
            <div class="item">
                <div class="items dinamic-des-mob">
    ...
    <section class="section dev">
            ...
            <!-- <section class="section-sm">
                <div class="container">
                    ...
                    <div class="s-card2">
                            ...
                            <p class="center">We guarantee customer fulfillment by following a conclusion to-finished <br>
                                    result testing procedure to give quickened conveyance of outstanding <br>
                                    advanced encounters.
                                    </p>
                                <h1>Skill Set</h1>
                            <p class="center">Our team is trained to solve problems and provide innovative <br>
                                    solutions tailored carefully to meet client needs. </p>
                    </div>    
            ...
            <section class="section">
                  ...
                  <div class="container">
                        <div class="row-flex android-app row-flex-android ">
                                <div class="s-card2 one-news col-lg-2 col-md-3 col-sm-4 ">
                                ...
                                <div class="s-card2 col-lg-2 col-md-3 col-sm-4">
                                    <div class="s-card2__icon2">
                ...
                <section class="section-sm">
                        <div class="s-card2">
                                <h1>Tool Set</h1>
                                <p class="center">Our team craftily translates their concepts into wireframes 
                                        and mockups to visually <br> illustrate their ideas and thoughts. </p>
                        </div>    
                </section>
                ...
                <section class="section bg-texture-2">
                       <div class="s-title s-title-shadow-left text-left">
                          <h1>Portfolio </h1>
                        </div>
