...
<section class="section ">
    <div class="container text-center">
         <h1>CHETU PROVIDES MAGENTO ECOMMERCE DEVELOPMENT FOR VAPE AND E-LIQUID RETAILER</h1>
    </div>
</section>
                ...
                <div class="row-flex">
                    <div class="col-6">
                            ...
                            <p class="">Chetu, a Magento partner, encounters this request often, taking concept to code with the intent of igniting a greater brand following, and ultimately, this is what our client sought to gain from our relationship. In order to do so, Chetu implemented and customized the following e-commerce platform.
                                  ...
                                  <br> <b> THE IMPACT : </b><br>
                                  At the onset of our relationship with this client, they were only interested in development work for two e-commerce sites, but as the project progressed the scope widened significantly. Chetu delivered 10 completed e-commerce solutions to the client. Each solution was as intuitive as the last, including an intelligent set of features to facilitate the user experience they desired.
                                  Among the most compelling of these features were… <br>
                             
                               <b> Age Verification:</b> 
                               Chetu instituted an age verification for the USA; this feature gave admins the power to establish a minimum age required to conduct any sales. For example, for Florida, our client locked the minimum age at 18+ to reflect the law prohibiting nicotine sales to minors. <br>
                               <b> Age Verification:</b> A single click option to minimize times, included preprogrammed taxing and order processing fees. <br>
                               
                               <b> Customized Wholesale Options:</b> Those coming to the site could opt into a customized bulk order process where they had the capacity to like and add products in bulk, rather than individually. <br>
