...
<section class="section ">
    <div class="container text-center">
         <h1>CHETU SIMPLIFIES USER EXPERIENCE AND OPTIMIZES TRANSPORTATION MANAGEMENT SYSTEM</h1>
    </div>
</section>
    ...
    <div class="container-fluid">
     <div class="container">
        <div class="flex-row">
            ...
            <div class="col-6">
                <img class="w-max" src="../img/project-img2/OPTIMIZES TRANSPORTATION MANAGEMENT SYSTEM/transportation-management-system-ferrosia.com3.png" alt="">
            </div>
        </div>
     </div>
   </div>
                ...
                <div class="flex-row">
                    <div class="col-6">
                            ...
                            <p class="">This venture is ongoing, existing as a continuous effort to maximize functionality in a way that outfits the client's operation. We're accomplishing this by engaging the following processes and technologies.
                                  ...
                                  <br> <b> The Process: </b><br>
                                    In order to fix existing accounting errors Chetu developers…
                              <ul>
                                <li> Developed a channel to enable passing of correct data to QuickBooks, providing better accuracy</li>
                                <li>Optimized database load time to enhance application performance</li> 
                                <li>Preformed tests on new technologies to ensure that entry issues were eliminated during system overhaul</li> 
                              </ul>
                               <b> THE IMPACT :</b> <br>
                    ...
                    <div class="col-6">
                            <img class="w-max " src="../img/project-img2/OPTIMIZES TRANSPORTATION MANAGEMENT SYSTEM/transportation-management-system-ferrosia.com4.png" alt="">
                    </div>
