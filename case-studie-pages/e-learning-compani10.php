...
<section class="section ">
    <div class="container text-center">
         <h1>E-LEARNING COMPANY CONNECTS WITH MAGENTO WEB SERVICE TO IMPROVE SALES DATA TRACKING EFFICIENCIES</h1>
    </div>
</section>
        ...
        <div class="flex-row">
            <div class="col-4">
                ...
                <p class="">THE CLIENT │ SPECIALIZED E-LEARNING TECHNOLOGY
                        ...
                        <ul>
                                <li>Custom eLearning courses</li>
                                <li>Immersive learning simulations</li>
                                <li>Specialized learning portals</li>
                                <li>Hosted Learning Management System</li>
                                <li>Hosted Course Authoring Software</li>
                    ...
                    <div class="col web-title">
                            ...
                            <p class="">Chetu leveraged the following technologies to carry the client's vision from concept to code:
                                   ...
                                   <ul>
                                       ...
                                       <li>PHP 5.3</li>
                                       <li>C++</li>
                                       <li>GIT (Versioning control system)</li>
                                   </ul>
                                   ...
                                   Chetu began by strategizing how to organize the sales report solution for the client. Chetu would include two menu options: a configuration page and view report screen.
                                    ...
                                    <ul>
                                            <li><b>Basic Configuration:</b> Basic configuration page will be used to save static text values, storage API selection and scheduler time selection.</li>
                                            <li><b>Payment Configuration:</b>Payment configuration page will provide the functionality to assign AHI payment code to the payments methods coming from Magento payment API.</li>
                                            <li><b>Site License Mapping:</b>Site license mapping will be used for the root site license mapping.
                                     </ul>
