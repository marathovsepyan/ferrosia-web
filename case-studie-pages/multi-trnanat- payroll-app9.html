...
<section class="section ">
    ...
    <div class="container-fluid">
      <div class="container">
        <div class="flex-row">
            <div class="col-6 ">
                <h3 class="" >PAYROLL: THE ENTERPRISE INEVITABILITY</h3>
                <p class="">Regardless the strength of your revenue stream or the scale of your workforce, some processes will remain a pain point. The necessary evil enterprises across the spectrum continue to encounter: payroll. Inevitably, there is a person (or persons) waiting to be compensated for the work they have completed.
                        Our client offers services to enterprises in need of payroll data entry, serving as an intermediary in the data entry storage and retrieval process. They have since snowballed into a leading payroll system provider, extending far beyond manual data entry to alleviate the stress stemming from the payroll process.
            ...
            <div class="">
                ...
                <div class="col ">
                        ...
                        <p class="text-center">The client was on a two-part mission: develop a service linking 3rd party systems, beginning with a small group of applications and scaling up, and locate a development company capable of engineering the multi-tenant app at a fair cost.
                                ...
                                Additionally, the application would generate files for state revenue services in compilation with the data retrieved from the third-party system. The client's HCM software unifies a diverse set of functionalities: time and attendance, HRIS Software, ACA tracking and reporting, plus payroll services.
                        </p>
                 </div>
            </div>
         </div>
                            ...
                            <p class="">Chetu needed to create an application that would enable the client to manage and auto generate revenue and payroll files directly from the Kronos System in order to populate third-party data in XML format. The application allows user to login into the system, manage system users, employers' data, and state revenue files per clients on a monthly basis.
                                   ...
                                   <ul>
                                    ...
                                    <ul>
                                            ...
                                            <li>Modifying attribute name and mapping of source (third-party) and target revenue service application.</li>
                                            <li>Creating and generating XML files for any employer on ad-hoc basis</li>
                                            Furthermore, Implementing and integrating Kronos software solutions into the application was able to provide the client with a suite of HCM tools such as payroll, time and attendance, absence management, and scheduling to help manage their workforce needs on a scalable cloud platform solution.
                                            Zooming out at the bigger picture, the multi-tenant application improved internal efficiencies. The client no longer needed employees to manually print UPS shipping labels. This greatly improved the integrity of the data, considering it was no longer subjected to human error. Chetu's development set the foundation for a new product the client is preparing to launch, greatly improving ROI.
                                     </ul>
                                </p>
                    </div>
                </div>
