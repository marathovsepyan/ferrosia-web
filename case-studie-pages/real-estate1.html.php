...
<section class="section ">
    <div class="container text-center">
         <h1>CHETU DEVELOPS REAL ESTATE APPLICATION THAT SIMPLIFIES BRIDGE LOANS</h1>
    </div>
</section>
            ...
            <div class="flex-row">
                ...
                <div class="col-6">
                        ...
                        <ul>
                            ...
                            <li>Investor selection</li> 
                            <li>Calculation of the projected investment costs</li> 
                            <li>Secretarial duties (legal paperwork and electronically signed documents)</li>
                            <li>Reporting features</li>
                            <li>Display dashboard for graphs and pie charts</li>
                            In other words, our client envisioned an intuitive application that granted users the power to scale each investor to the amount they were willing to invest and then pair them to projects accordingly. Most importantly, the application needed to be equipped with an electronic bill payment and presentment (EBPP) feature to enable ACH / credit card payments.</p>
                        </ul>
                 </div>
            </div>
        </div>
