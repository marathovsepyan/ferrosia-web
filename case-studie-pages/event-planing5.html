...
<section class="section ">
    <div class="container text-center">
         <h1>CHETU ADDRESSES EVENT PLANNING INEFFICIENCIES WITH CUSTOM SOLUTIONS</h1>
    </div>
</section>
                ...
                <div class="flex-row">
                    <div class="col-6">
                            ...
                            <p class="">The client did copious amounts of research before approaching Chetu to ensure they brought their idea to the most certified software development company, who could understand and fulfill its potential. Chetu drew on its vast experience developing and integrating custom planning software to create a solution that met and exceeded the client's expectation.
                              ...
                              <ul>
                                <li> A marketing portal created in WordPress connected to the client's database using MySQL.</li>
                                <li>Data and event management through a web application that provides different input forms to manage unique users and events data.</li> 
                                <li>Sharing and managing documents with Dropbox integration.</li> 
                                <li>Email notifications utilizing the Mandrill API to allow the client to easily change / control templates plus wording of emails.</li> 
